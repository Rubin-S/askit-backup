...
function Login1() {
  ...
  return (
    <div className="signin1-container">
      ...
      <div className="right">
        <h1>Log in</h1>
        <p>Login to connect, post, or find the services you need.</p>
        ...
        <div className="input-verify input-space">
          <input type="text" className="verify-phone-input" />
        </div>
        ...
        <div className="verify-button-group-hor">
          <button onClick={() => navigate("/")} className="verify-home-button">
            Back
          </button>
          <button className="verify-complete-button">Log in</button>
        </div>

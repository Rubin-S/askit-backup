  ...
  return (
    <div className="signin1-container">
      ...
      <div className="right right-reset right-recover">
        ...
        <label htmlFor="password">Enter your registered mobile number</label>
        ...
        <div id="reset-button" className="verify-button-group-hor">
          <button onClick={()=>navigate("/account-recover-options")} className="verify-home-button">Try another way</button>
          <button

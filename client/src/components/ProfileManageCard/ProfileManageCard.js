...
import "../ServiceFormComp/Styles/ProfileCard.css";
import profileImg from "../../Assets/verify/profile-manage-card.png";
import "./ProfileManageCard.css";
const ProfileManageCard = ({
  ...
  rating = 0,
  reviews = 0,
  userName = formData.name || "Your Profile",
  ...
  return (
    <div className="card-preview-container">
      <div className="card-header">
        <div className="card-image-manage-wrapper">
          <img
            src={
              image
                ? typeof image === "string"
...
export default ProfileManageCard;
